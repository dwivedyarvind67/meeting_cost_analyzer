...
export default function LoginPage() {
  ...
  const loginWithGoogle = useGoogleLogin({
    ...
    onSuccess: async (tokenResponse) => {
      ...
      setLoading(true);
      try {
        const res = await api.post("/google-login-access", {
        ...
        // Save the calendar token for auto-sync without asking
        ...
        <div className="glass-card-static p-8 md:p-10 relative">
          ...
          <div className="flex justify-center mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-black py-3 rounded-full font-semibold shadow-md hover:bg-gray-100 transition-colors"
            >
